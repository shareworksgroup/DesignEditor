...
class CheckBoxWithInputDynamic extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      open: false
  ...
  searchTextOnchange = (e) => {
    this.props.searchTextOnchange(e.target.value)    
  }
  ...
  render() {
    ...
    const showSelectAll = data.length !== 0
          ...
          <ul className="multiselect-container dropdown-menu">
            <li className="multiselect-item filter" value="0">
              <div className="input-group">
                ...
                <input value={query} onChange={this.searchTextOnchange} className="form-control multiselect-search" type="text" placeholder="Search" aria-invalid="false" />
                <span className="input-group-btn">
                  <button onClick={this.clearSearchText} className="btn btn-default multiselect-clear-filter" type="button">
...
export default mobxReact.observer(CheckBoxWithInputDynamic)