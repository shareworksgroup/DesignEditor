  ...
  return class extends Comp {
    ...
    componentDidMount() {
      if (this.props.dragEnabled) {
        ...
        this.containerNode.setAttribute('data-key', this.props.item[this.props.keyProp]);
      }
    }
      ...
      return (
        <div ref={node => {
          ...
          <DisplayObject
            ...
            onSetDragNode={ dragNode => { this.defaultDragNode = false; this.domNode = dragNode; } } 
