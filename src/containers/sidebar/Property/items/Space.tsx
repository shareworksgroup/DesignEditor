    ...
    return <div className="ds-widget ds-link-widget">
          ...
          <div className="ds-widget-label">
            <label>
              <span
                ...
                onClick={() => { this.onMore(!this.state.more); }}>
                More Options
              </span>
      ...
      {this.state.more && <div className="row more-options" style={{ marginTop: 10 }}>
        <div className="col-6">
          ...
          <div className="ds-color-picker">
            <Number max={500} step={1} formatter={Formatter} value={this.state.top} onChange={val => { this.onChange(Operate.TOP, val); }} />
          </div>
        </div>
        <div className="col-6">
          <div className="ds-widget-label"><label><span>Right</span></label></div>
          <div className="ds-color-picker">
            <Number max={500} step={1} formatter={Formatter} value={this.state.right} onChange={val => { this.onChange(Operate.RIGHT, val); }} />
          </div>
        </div>
        <div className="col-6">
          <div className="ds-widget-label"><label><span>Left</span></label></div>
          <div className="ds-color-picker">
            <Number max={500} step={1} formatter={Formatter} value={this.state.left} onChange={val => { this.onChange(Operate.LEFT, val); }} />
          </div>
        </div>
        <div className="col-6">
          <div className="ds-widget-label"><label><span>Bottom</span></label></div>
          <div className="ds-color-picker">
            <Number max={500} step={1} formatter={Formatter} value={this.state.bottom} onChange={val => { this.onChange(Operate.BOTTOM, val); }} />
          </div>
        </div>
      </div>}
      {!this.state.more && <div className="card-row" style={{ marginTop: 10 }}>
        <div className="col-6">
          ...
          <div className="ds-color-picker">
            <Number max={500} step={1} formatter={Formatter} value={this.state.all} onChange={val => { this.onChange(Operate.ALL, val); }} />
          </div>
        </div>
      </div>}
    </div>;
