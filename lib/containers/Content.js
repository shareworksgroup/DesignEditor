...
var Content = /** @class */ (function (_super) {
    ...
    Content.prototype.render = function () {
        ...
        return React.createElement(Group, { title: "Gereral", className: "content-card" },
            React.createElement("ul", { className: "ds_content" }, rootStore.DesignState.extensions.map(function (Extension) {
                var instance = new Extension();
                return ContentFactory(instance.getContentType(), instance.getLabel(), instance.getIconClass());
            })
                .map(function (Component, index) { return React.createElement(Component, { key: index }); })));
    };
    Content = __decorate([
        inject('rootStore'),
        observer
